...
kill @e[tag=blueg]
summon armor_stand ^ ^-1.2 ^-0.494 {Invisible:1b,Invulnerable:1b,NoBasePlate:1b,NoGravity:1b,ArmorItems:[{},{},{},{}],HandItems:[{},{}],DisabledSlots:2037535,Tags:["portal","portalambientloop","wall","blueportal","south","bluep","hoverignore"],Rotation:[180.0f,0.0f]}
