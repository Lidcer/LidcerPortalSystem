...
summon armor_stand ^ ^-1.2 ^-0.492 {Invisible:1b,Invulnerable:1b,PersistenceRequired:1b,NoBasePlate:1b,NoGravity:1b,ArmorItems:[{},{},{},{}],HandItems:[{},{}],DisabledSlots:2037535,Tags:["portal","portalambientloop","wall","lightblueportal","north","lightbluep","hoverignore"],Rotation:[0.0f,0.0f]}
