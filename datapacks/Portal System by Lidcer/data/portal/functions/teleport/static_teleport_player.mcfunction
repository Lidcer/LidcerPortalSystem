...
##########################################################################################################################################################################################################################################################
execute as @e[type=minecraft:armor_stand,tag=blueportal] at @e[type=minecraft:armor_stand,tag=orangeportal,tag=floor] run tag @e[tag=!portal,tag=!tpignore,tag=cube,tag=!VELO,distance=..0.7] add TPorange
execute as @e[type=minecraft:armor_stand,tag=orangeportal] at @e[type=minecraft:armor_stand,tag=blueportal,tag=floor] run tag @e[tag=!portal,tag=!tpignore,tag=cube,tag=!VELO,distance=..0.7] add TPblue
...
execute as @e[type=minecraft:armor_stand,tag=blueportal] at @e[type=minecraft:armor_stand,tag=orangeportal,tag=floor] run tag @e[scores={velocityEntity=..-700},distance=..0.7] add TPorange
execute as @e[type=minecraft:armor_stand,tag=orangeportal] at @e[type=minecraft:armor_stand,tag=blueportal,tag=floor] run tag @e[scores={velocityEntity=..-700},distance=..0.7] add TPblue
...
execute as @a[tag=TPblue] at @s unless entity @e[type=minecraft:armor_stand,tag=VELO] unless entity @e[type=minecraft:armor_stand,tag=orangeportal,tag=ceiling] run tp @s @e[type=minecraft:armor_stand,tag=orangeportal,tag=portalambientloop,limit=1]
execute as @a[tag=TPblue] at @s unless entity @e[type=minecraft:armor_stand,tag=VELO] if entity @e[type=minecraft:armor_stand,tag=orangeportal,tag=ceiling] if score Velocity config matches 0 run tp @s @e[type=minecraft:armor_stand,tag=orangeportal,tag=portalambientloop,limit=1]
execute as @a[tag=TPblue] at @e[type=minecraft:armor_stand,tag=orangeportal,tag=portalambientloop] unless entity @e[type=minecraft:armor_stand,tag=VELO] if entity @e[type=minecraft:armor_stand,tag=blueportal,tag=floor] if score Velocity config matches 1 run tp @s ~ ~ ~ ~ 0
execute as @a[tag=TPblue] at @s if entity @e[type=minecraft:armor_stand,tag=VELO] run tp @s @e[type=minecraft:armor_stand,tag=orangeportal,tag=!no,limit=1]
...
execute as @a[tag=TPblue] at @s if entity @e[type=minecraft:armor_stand,tag=floor,tag=orangeportal] at @e[type=minecraft:armor_stand,tag=floor,tag=orangeportal] run tp @s ~ ~1.6 ~ ~ 0
execute as @a[tag=TPblue] at @s if entity @e[type=minecraft:armor_stand,tag=ceiling,tag=orangeportal] at @e[type=minecraft:armor_stand,tag=ceiling,tag=orangeportal] run tp @s ~ ~-1 ~ ~ 0
...
execute as @e[type=minecraft:area_effect_cloud,tag=TPblue] at @e[type=minecraft:armor_stand,tag=blueportal] if score Sound config matches 1 run playsound minecraft:portal_enter_1 ambient @a ~ ~ ~ 0.2
execute as @e[type=minecraft:area_effect_cloud,tag=TPblue] at @e[type=minecraft:armor_stand,tag=blueportal] if score Sound config matches 2 run playsound minecraft:portal_enter_2 ambient @a ~ ~ ~ 0.2

execute as @e[type=minecraft:area_effect_cloud,tag=TPblue] at @s unless entity @e[type=minecraft:armor_stand,tag=VELO] unless entity @e[type=minecraft:armor_stand,tag=orangeportal,tag=ceiling] run tp @s @e[type=minecraft:armor_stand,tag=orangeportal,tag=portalambientloop,limit=1]
execute as @e[type=minecraft:area_effect_cloud,tag=TPblue] at @s unless entity @e[type=minecraft:armor_stand,tag=VELO] if entity @e[type=minecraft:armor_stand,tag=orangeportal,tag=ceiling] if score Velocity config matches 0 run tp @s @e[type=minecraft:armor_stand,tag=orangeportal,tag=portalambientloop,limit=1]
execute as @e[type=minecraft:area_effect_cloud,tag=TPblue] at @e[type=minecraft:armor_stand,tag=orangeportal,tag=portalambientloop] unless entity @e[type=minecraft:armor_stand,tag=VELO] if entity @e[type=minecraft:armor_stand,tag=blueportal,tag=floor] if score Velocity config matches 1 run tp @s ~ ~ ~ ~ 0
execute as @e[type=minecraft:area_effect_cloud,tag=TPblue] at @s if entity @e[type=minecraft:armor_stand,tag=VELO] run tp @s @e[type=minecraft:armor_stand,tag=orangeportal,tag=!no,limit=1]

execute as @e[type=minecraft:area_effect_cloud,tag=TPblue] at @s if entity @e[type=minecraft:armor_stand,tag=orangeportal,tag=wall] at @e[type=minecraft:armor_stand,tag=orangeportal,tag=wall] run tp @s ^ ^ ^0.6
execute as @e[type=minecraft:area_effect_cloud,tag=TPblue] at @s if entity @e[type=minecraft:armor_stand,tag=floor,tag=orangeportal] at @e[type=minecraft:armor_stand,tag=floor,tag=orangeportal] run tp @s ~ ~1.6 ~ ~ 0
execute as @e[type=minecraft:area_effect_cloud,tag=TPblue] at @s if entity @e[type=minecraft:armor_stand,tag=ceiling,tag=orangeportal] at @e[type=minecraft:armor_stand,tag=ceiling,tag=orangeportal] run tp @s ~ ~-1 ~ ~ 0

execute as @e[type=minecraft:area_effect_cloud,tag=TPblue] at @e[type=minecraft:armor_stand,tag=orangeportal] if score Sound config matches 1 run playsound minecraft:portal_exit_1 ambient @a ~ ~ ~ 0.2
execute as @e[type=minecraft:area_effect_cloud,tag=TPblue] at @e[type=minecraft:armor_stand,tag=orangeportal] if score Sound config matches 2 run playsound minecraft:portal_exit_2 ambient @a ~ ~ ~ 0.2
##########################################################################################################################################################################################################################################################
...
execute as @e[type=minecraft:armor_stand,tag=TPblue] at @s if entity @e[type=minecraft:armor_stand,tag=orangeportal,tag=north] if score Velocity config matches 1 if entity @e[tag=blueportal,tag=floor] store result entity @s Motion[2] double 0.00021 run scoreboard players get @s velocityEntityY
...
execute as @a[tag=TPorange] at @s unless entity @e[type=minecraft:armor_stand,tag=VELO] unless entity @e[type=minecraft:armor_stand,tag=blueportal,tag=ceiling] run tp @s @e[type=minecraft:armor_stand,tag=blueportal,tag=portalambientloop,limit=1]
execute as @a[tag=TPorange] at @s unless entity @e[type=minecraft:armor_stand,tag=VELO] if entity @e[type=minecraft:armor_stand,tag=blueportal,tag=ceiling] if score Velocity config matches 0 run tp @s @e[type=minecraft:armor_stand,tag=blueportal,tag=portalambientloop,limit=1]
execute as @a[tag=TPorange] at @e[type=minecraft:armor_stand,tag=blueportal,tag=portalambientloop] unless entity @e[type=minecraft:armor_stand,tag=VELO] if entity @e[type=minecraft:armor_stand,tag=orangeportal,tag=floor] if score Velocity config matches 1 run tp @s ~ ~ ~ ~ 0
execute as @a[tag=TPorange] at @s if entity @e[type=minecraft:armor_stand,tag=VELO] run tp @s @e[type=minecraft:armor_stand,tag=blueportal,tag=!no,limit=1]
...
execute as @a[tag=TPorange] at @s if entity @e[type=minecraft:armor_stand,tag=floor,tag=blueportal] at @e[type=minecraft:armor_stand,tag=floor,tag=blueportal] run tp @s ~ ~1.6 ~ ~ 0
execute as @a[tag=TPorange] at @s if entity @e[type=minecraft:armor_stand,tag=ceiling,tag=blueportal] at @e[type=minecraft:armor_stand,tag=ceiling,tag=blueportal] run tp @s ~ ~-1 ~ ~ 0
...
execute as @e[type=minecraft:armor_stand,tag=TPorange] at @s unless entity @e[type=minecraft:armor_stand,tag=VELO] unless entity @e[type=minecraft:armor_stand,tag=blueportal,tag=ceiling] run tp @s @e[type=minecraft:armor_stand,tag=blueportal,tag=portalambientloop,limit=1]
execute as @e[type=minecraft:armor_stand,tag=TPorange] at @s unless entity @e[type=minecraft:armor_stand,tag=VELO] if entity @e[type=minecraft:armor_stand,tag=blueportal,tag=ceiling] if score Velocity config matches 0 run tp @s @e[type=minecraft:armor_stand,tag=blueportal,tag=portalambientloop,limit=1]
execute as @e[type=minecraft:armor_stand,tag=TPorange] at @e[type=minecraft:armor_stand,tag=blueportal,tag=portalambientloop] unless entity @e[type=minecraft:armor_stand,tag=VELO] if entity @e[type=minecraft:armor_stand,tag=orangeportal,tag=floor] if score Velocity config matches 1 run tp @s ~ ~ ~ ~ 0
execute as @e[type=minecraft:armor_stand,tag=TPorange] at @s if entity @e[type=minecraft:armor_stand,tag=VELO] run tp @s @e[type=minecraft:armor_stand,tag=blueportal,tag=!no,limit=1]
...
execute as @e[type=minecraft:armor_stand,tag=TPorange] at @s if entity @e[type=minecraft:armor_stand,tag=floor,tag=blueportal] at @e[type=minecraft:armor_stand,tag=floor,tag=blueportal] run tp @s ~ ~1.6 ~ ~ 0
execute as @e[type=minecraft:armor_stand,tag=TPorange] at @s if entity @e[type=minecraft:armor_stand,tag=ceiling,tag=blueportal] at @e[type=minecraft:armor_stand,tag=ceiling,tag=blueportal] run tp @s ~ ~-1 ~ ~ 0
...
execute as @e[type=minecraft:armor_stand,tag=TPorange] at @s if entity @e[type=minecraft:armor_stand,tag=blueportal,tag=portalambientloop,tag=ceiling] if score Velocity config matches 1 if entity @e[type=minecraft:armor_stand,tag=orangeportal,tag=portalambientloop,tag=floor] store result entity @s Motion[1] double 0.00021 run scoreboard players get @s velocityEntityY
