...
###################################################################################################################################################################################
data merge entity @e[type=minecraft:armor_stand,tag=blueg,limit=1] {Glowing:0}
data merge entity @e[type=minecraft:armor_stand,tag=orangeg,limit=1] {Glowing:0}
...
execute as @a[tag=BOPG,scores={shift=1..}] at @s run data merge entity @e[type=minecraft:armor_stand,tag=blueg,limit=1] {Glowing:1}
execute as @a[tag=BOPG,scores={shift=1..}] at @s run data merge entity @e[type=minecraft:armor_stand,tag=orangeg,limit=1] {Glowing:1}

execute as @a[tag=LBPPG,scores={shift=1..}] at @s run data merge entity @e[type=minecraft:armor_stand,tag=lightblueg,limit=1] {Glowing:1}
execute as @a[tag=LBPPG,scores={shift=1..}] at @s run data merge entity @e[type=minecraft:armor_stand,tag=purpleg,limit=1] {Glowing:1}

execute as @a[tag=YRPG,scores={shift=1..}] at @s run data merge entity @e[type=minecraft:armor_stand,tag=yellowg,limit=1] {Glowing:1}
execute as @a[tag=YRPG,scores={shift=1..}] at @s run data merge entity @e[type=minecraft:armor_stand,tag=redg,limit=1] {Glowing:1}
