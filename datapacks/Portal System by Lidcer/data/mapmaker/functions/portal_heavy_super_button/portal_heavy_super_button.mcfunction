...
give @a[tag=portalbutton_1_setup,gamemode=creative,nbt=!{Inventory:[{id:"minecraft:carrot_on_a_stick",tag:{Tags:["portal_heavy_super_button_tool_1"]}}]}] minecraft:carrot_on_a_stick{Unbreakable:1,display:{Name:"{\"text\":\"Aperture Science Universal Editor\"}",Lore:["Portal Door - 1"]},HideFlags:63,Tags:["portal_heavy_super_button_tool_1"],Damage:17} 1
give @a[tag=portalbutton_2_setup,gamemode=creative,nbt=!{Inventory:[{id:"minecraft:carrot_on_a_stick",tag:{Tags:["portal_heavy_super_button_tool_2"]}}]}] minecraft:carrot_on_a_stick{Unbreakable:1,display:{Name:"{\"text\":\"Aperture Science Universal Editor\"}",Lore:["Portal Door - 2"]},HideFlags:63,Tags:["portal_heavy_super_button_tool_2"],Damage:17} 1

give @a[tag=portalbutton_1_setup,gamemode=creative,nbt=!{Inventory:[{id:"minecraft:carrot_on_a_stick",tag:{Tags:["exit_tool"]}}]}] minecraft:carrot_on_a_stick{Unbreakable:1,display:{Name:"{\"text\":\"Aperture Science Universal Editor - Exit\",\"color\":\"black\"}",Lore:["Exit Editor"]},HideFlags:63,Tags:["exit_tool","menu2"],Damage:16} 1
give @a[tag=portalbutton_2_setup,gamemode=creative,nbt=!{Inventory:[{id:"minecraft:carrot_on_a_stick",tag:{Tags:["exit_tool"]}}]}] minecraft:carrot_on_a_stick{Unbreakable:1,display:{Name:"{\"text\":\"Aperture Science Universal Editor - Exit\",\"color\":\"black\"}",Lore:["Exit Editor"]},HideFlags:63,Tags:["exit_tool","menu2"],Damage:16} 1

execute as @a[tag=portalbutton_1_setup,nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{Tags:["portal_heavy_super_button_tool_1"]}}}] at @s unless entity @e[tag=portal_heavy_super_button_setup_1] run summon armor_stand ^ ^ ^ {Invisible:1b,Invulnerable:1b,PersistenceRequired:1b,NoBasePlate:1b,NoGravity:1b,ArmorItems:[{},{},{},{id:"diamond_hoe",Count:1b,tag:{Damage:1461,Unbreakable:1}}],DisabledSlots:2037535,Tags:["portal_heavy_super_button_setup_1","useless","button","tpignore","hoverignore"],Glowing:1}
execute as @a[tag=portalbutton_2_setup,nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{Tags:["portal_heavy_super_button_tool_2"]}}}] at @s unless entity @e[tag=portal_heavy_super_button_setup_2] run summon armor_stand ^ ^ ^ {Invisible:1b,Invulnerable:1b,PersistenceRequired:1b,NoBasePlate:1b,NoGravity:1b,ArmorItems:[{},{},{},{id:"diamond_hoe",Count:1b,tag:{Damage:1461,Unbreakable:1}}],DisabledSlots:2037535,Tags:["portal_heavy_super_button_setup_2","useless","button","tpignore","hoverignore"],Glowing:1}
...
execute as @e[type=minecraft:armor_stand,tag=portal_heavy_super_button_set_1] run data merge entity @s {Glowing:0}
execute as @e[type=minecraft:armor_stand,tag=portal_heavy_super_button_set_2] run data merge entity @s {Glowing:0}

execute as @e[type=minecraft:armor_stand,tag=portal_heavy_super_button_set_1,tag=portal_heavy_super_button_setup_1] at @s run summon armor_stand ^ ^0.15 ^ {Invisible:1b,Invulnerable:1b,PersistenceRequired:1b,NoBasePlate:1b,NoGravity:1b,ArmorItems:[{},{},{},{id:"diamond_hoe",Count:1b,tag:{Damage:1460,Unbreakable:1}}],DisabledSlots:2037535,Tags:["portal_button_plate_1","button","tpignore","hoverignore"]}
execute as @e[type=minecraft:armor_stand,tag=portal_heavy_super_button_set_2,tag=portal_heavy_super_button_setup_2] at @s run summon armor_stand ^ ^0.15 ^ {Invisible:1b,Invulnerable:1b,PersistenceRequired:1b,NoBasePlate:1b,NoGravity:1b,ArmorItems:[{},{},{},{id:"diamond_hoe",Count:1b,tag:{Damage:1458,Unbreakable:1}}],DisabledSlots:2037535,Tags:["portal_button_plate_2","button","tpignore","hoverignore"]}
