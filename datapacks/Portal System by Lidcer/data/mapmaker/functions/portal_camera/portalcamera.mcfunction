...
give @a[tag=portalcam_1_setup,gamemode=creative,nbt=!{Inventory:[{id:"minecraft:carrot_on_a_stick",tag:{Tags:["portalcam_tool_1"]}}]}] minecraft:carrot_on_a_stick{Unbreakable:1b,display:{Name:"{\"text\":\"Portal Security Camera - 1\"}",Lore:["Portal Security Camera - 1"]},HideFlags:63,Tags:["portalcam_tool_1"],Damage:17} 1
give @a[tag=portalcam_2_setup,gamemode=creative,nbt=!{Inventory:[{id:"minecraft:carrot_on_a_stick",tag:{Tags:["portalcam_tool_2"]}}]}] minecraft:carrot_on_a_stick{Unbreakable:1b,display:{Name:"{\"text\":\"Portal Security Camera - 2\"}",Lore:["Portal Security Camera - 2"]},HideFlags:63,Tags:["portalcam_tool_2"],Damage:17} 1

give @a[tag=portalcam_1_setup,gamemode=creative,nbt=!{Inventory:[{id:"minecraft:carrot_on_a_stick",tag:{Tags:["exit_tool"]}}]}] minecraft:carrot_on_a_stick{Unbreakable:1b,display:{Name:"{\"text\":\"Aperture Science Universal Editor - Exit\",\"color\":\"black\"}",Lore:["Exit Editor"]},HideFlags:63,Tags:["exit_tool","menu1"],Damage:16} 1
give @a[tag=portalcam_2_setup,gamemode=creative,nbt=!{Inventory:[{id:"minecraft:carrot_on_a_stick",tag:{Tags:["exit_tool"]}}]}] minecraft:carrot_on_a_stick{Unbreakable:1b,display:{Name:"{\"text\":\"Aperture Science Universal Editor - Exit\",\"color\":\"black\"}",Lore:["Exit Editor"]},HideFlags:63,Tags:["exit_tool","menu1"],Damage:16} 1

execute as @a[tag=portalcam_1_setup] at @s unless entity @e[type=minecraft:armor_stand,tag=portalcamera_setup] run summon armor_stand ^ ^ ^ {Invisible:1b,Invulnerable:1b,NoBasePlate:1b,NoGravity:1b,ArmorItems:[{},{},{},{id:"diamond_hoe",Count:1b,tag:{Damage:1511,Unbreakable:1}}],DisabledSlots:2037535,Tags:["portalcamera_setup","useless","cam1"],Glowing:1b}
execute as @a[tag=portalcam_2_setup] at @s unless entity @e[type=minecraft:armor_stand,tag=portalcamera_setup] run summon armor_stand ^ ^ ^ {Invisible:1b,Invulnerable:1b,NoBasePlate:1b,NoGravity:1b,ArmorItems:[{},{},{},{id:"diamond_hoe",Count:1b,tag:{Damage:1507,Unbreakable:1}}],DisabledSlots:2037535,Tags:["portalcamera_setup","useless","cam2"],Glowing:1b}
...
execute as @e[type=minecraft:armor_stand,tag=portalcam_set,tag=cam1] at @s unless entity @e[tag=portalcam_head,distance=..2] run summon minecraft:villager ^ ^-1.0 ^ {NoAI:1b,Silent:1b,Invulnerable:1b,NoGravity:1b,ArmorItems:[{},{},{},{id:"diamond_hoe",Count:1b,tag:{Damage:1513,Unbreakable:1}}],Tags:["portalcam_head_1","pco","cam","hoverignore"],ActiveEffects:[{Id:14b,Amplifier:0b,Duration:20000000,ShowParticles:0b}]}
execute as @e[type=minecraft:armor_stand,tag=portalcam_set,tag=cam1] at @s unless entity @e[tag=portalcam_side,distance=..2] run summon armor_stand ^ ^-1.0 ^ {Invisible:1b,Invulnerable:1b,NoBasePlate:1b,NoGravity:1b,ArmorItems:[{},{},{},{id:"diamond_hoe",Count:1b,tag:{Damage:1512,Unbreakable:1}}],DisabledSlots:2037535,Tags:["portalcam_side_1","pco","cam","cam1","hoverignore","lookingatyou"]}
execute as @e[type=minecraft:armor_stand,tag=portalcam_set,tag=cam1] at @s unless entity @e[tag=portalcam_base,distance=..2] run summon armor_stand ^ ^-1.0 ^ {Invisible:1b,Invulnerable:1b,NoBasePlate:1b,NoGravity:1b,ArmorItems:[{},{},{},{id:"diamond_hoe",Count:1b,tag:{Damage:1514,Unbreakable:1}}],DisabledSlots:2037535,Tags:["portalcam_base_1","pco","cam","cam1","hoverignore"]}

execute as @e[type=minecraft:armor_stand,tag=portalcam_set,tag=cam2] at @s unless entity @e[tag=portalcam_side,distance=..2] run summon minecraft:villager ^ ^1 ^ {NoAI:1b,Silent:1b,Invulnerable:1b,NoGravity:1b,ArmorItems:[{},{},{},{id:"diamond_hoe",Count:1b,tag:{Damage:1508,Unbreakable:1}}],Tags:["portalcam_head_2","lookingatyou","pco","cam","hoverignore"],ActiveEffects:[{Id:14b,Amplifier:0b,Duration:20000000,ShowParticles:0b}]}
execute as @e[type=minecraft:armor_stand,tag=portalcam_set,tag=cam2] at @s unless entity @e[tag=portalcam_base,distance=..2] run summon armor_stand ^ ^1 ^ {Invisible:1b,Invulnerable:1b,NoBasePlate:1b,NoGravity:1b,ArmorItems:[{},{},{},{id:"diamond_hoe",Count:1b,tag:{Damage:1509,Unbreakable:1}}],DisabledSlots:2037535,Tags:["portalcam_base_2","pco","cam","hoverignore"]}
