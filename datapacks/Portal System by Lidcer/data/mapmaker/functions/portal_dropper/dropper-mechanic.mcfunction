...
execute as @e[type=minecraft:armor_stand,tag=1pcd1,tag=!useless,tag=activated] at @s positioned ~ ~3 ~ unless entity @e[tag=cube,tag=1cubetag1,tag=1insidedrop1] run summon armor_stand ~ ~1 ~ {Invisible:1b,Invulnerable:1b,PersistenceRequired:1b,NoBasePlate:1b,NoGravity:1b,ArmorItems:[{},{},{},{id:"diamond_hoe",Count:1b,tag:{Damage:1457,Unbreakable:1}}],DisabledSlots:2037535,Tags:["cube_setup_s_1_set","cube","hoverignore","tpignore","1cubetag1","1insidedrop1"] }
...
execute as @e[type=minecraft:armor_stand,tag=1pcd2,tag=!useless,tag=activated] at @s positioned ~ ~3 ~ unless entity @e[tag=cube,tag=1cubetag2,tag=1insidedrop2] run summon armor_stand ~ ~1 ~ {Invisible:1b,Invulnerable:1b,PersistenceRequired:1b,NoBasePlate:1b,NoGravity:1b,ArmorItems:[{},{},{},{id:"diamond_hoe",Count:1b,tag:{Damage:1457,Unbreakable:1}}],DisabledSlots:2037535,Tags:["cube_setup_s_1_set","cube","hoverignore","tpignore","1cubetag2","1insidedrop2"] }
...
execute as @e[type=minecraft:armor_stand,tag=1pcd3,tag=!useless,tag=activated] at @s positioned ~ ~3 ~ unless entity @e[tag=cube,tag=1cubetag3,tag=1insidedrop3] run summon armor_stand ~ ~1 ~ {Invisible:1b,Invulnerable:1b,PersistenceRequired:1b,NoBasePlate:1b,NoGravity:1b,ArmorItems:[{},{},{},{id:"diamond_hoe",Count:1b,tag:{Damage:1457,Unbreakable:1}}],DisabledSlots:2037535,Tags:["cube_setup_s_1_set","cube","hoverignore","tpignore","1cubetag3","1insidedrop3"] }
...
execute as @e[type=minecraft:armor_stand,tag=1pcd4,tag=!useless,tag=activated] at @s positioned ~ ~3 ~ unless entity @e[tag=cube,tag=1cubetag4,tag=1insidedrop4] run summon armor_stand ~ ~1 ~ {Invisible:1b,Invulnerable:1b,PersistenceRequired:1b,NoBasePlate:1b,NoGravity:1b,ArmorItems:[{},{},{},{id:"diamond_hoe",Count:1b,tag:{Damage:1457,Unbreakable:1}}],DisabledSlots:2037535,Tags:["cube_setup_s_1_set","cube","hoverignore","tpignore","1cubetag4","1insidedrop4"] }
...
execute as @e[type=minecraft:armor_stand,tag=1pcd5,tag=!useless,tag=activated] at @s positioned ~ ~3 ~ unless entity @e[tag=cube,tag=1cubetag5,tag=1insidedrop5] run summon armor_stand ~ ~1 ~ {Invisible:1b,Invulnerable:1b,PersistenceRequired:1b,NoBasePlate:1b,NoGravity:1b,ArmorItems:[{},{},{},{id:"diamond_hoe",Count:1b,tag:{Damage:1456,Unbreakable:1}}],DisabledSlots:2037535,Tags:["cube_setup_c_1_set","cube","hoverignore","tpignore","1cubetag5","1insidedrop5"] }
...
execute as @e[type=minecraft:armor_stand,tag=2pcd5,tag=!useless,tag=activated] at @s unless entity @s[scores={animationtime=0..}] positioned ~ ~3 ~ unless entity @e[tag=cube,tag=2cubetag5,tag=2insidedrop5] run summon armor_stand ~ ~1 ~ {Invisible:1b,Invulnerable:1b,PersistenceRequired:1b,NoBasePlate:1b,NoGravity:1b,ArmorItems:[{},{},{},{id:"diamond_hoe",Count:1b,tag:{Damage:1454,Unbreakable:1}}],DisabledSlots:2037535,Tags:["cube_setup_c_1_set","por2c","cube","hoverignore","tpignore","2cubetag5","2insidedrop5"] }
...
#execute as @e[type=minecraft:armor_stand,tag=2pcd7,tag=!useless,tag=activated] at @s unless entity @s[scores={animationtime=0..}] positioned ~ ~3 ~ unless entity @e[tag=cube,tag=2cubetag7,tag=2insidedrop7] run summon armor_stand ~ ~1 ~ {Invisible:1b,Invulnerable:1b,PersistenceRequired:1b,NoBasePlate:1b,NoGravity:1b,ArmorItems:[{},{},{},{id:"diamond_hoe",Count:1b,tag:{Damage:1454,Unbreakable:1}}],DisabledSlots:2037535,Tags:["cube_setup_c_1_set","por2c","cube","hoverignore","tpignore","2cubetag7","2insidedrop7"] }
