...
give @a[tag=aerialfaithplate_setup,gamemode=creative,nbt=!{Inventory:[{id:"minecraft:carrot_on_a_stick",tag:{Tags:["aerialfaithplate_tool"]}}]}] minecraft:carrot_on_a_stick{Unbreakable:1,display:{Name:"{\"text\":\"Aperture Science Universal Editor\"}",Lore:["Aerial Faith Plate- 1"]},HideFlags:63,Tags:["aerialfaithplate_tool"],Damage:17} 1

give @a[tag=aerialfaithplate_setup,gamemode=creative,nbt=!{Inventory:[{id:"minecraft:carrot_on_a_stick",tag:{Tags:["exit_tool"]}}]}] minecraft:carrot_on_a_stick{Unbreakable:1,display:{Name:"{\"text\":\"Aperture Science Universal Editor - Exit\",\"color\":\"black\"}",Lore:["Exit Editor"]},HideFlags:63,Tags:["exit_tool","menu1"],Damage:16} 1

execute as @a[tag=aerialfaithplate_setup,nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{Tags:["aerialfaithplate_tool"]}}}] at @s unless entity @e[tag=aerialfaithplate_setup_1] run summon armor_stand ^ ^ ^ {Invisible:1b,Invulnerable:1b,PersistenceRequired:1b,NoBasePlate:1b,NoGravity:1b,ArmorItems:[{},{},{},{id:"diamond_hoe",Count:1b,tag:{Damage:1422,Unbreakable:1}}],DisabledSlots:2037535,Tags:["aerialfaithplate_setup_1","useless","tpignore","hoverignore"],Glowing:1}
...
execute as @e[type=minecraft:armor_stand,tag=aerialfaithplate_set] run data merge entity @s {Glowing:0}
...
execute as @e[type=minecraft:armor_stand,tag=aerialfaithplate_set] at @s run summon armor_stand ~ ~-0.5 ~ {Invisible:1b,Invulnerable:1b,PersistenceRequired:1b,NoBasePlate:1b,NoGravity:1b,ArmorItems:[{},{},{},{id:"diamond_hoe",Count:1b,tag:{Damage:1421,Unbreakable:1}}],Tags:["aerialfaithplate","tpignore","hoverignore"],DisabledSlots:2037535}
