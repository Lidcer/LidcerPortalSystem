...
give @a[tag=material_emancipation_grill_1_setup,gamemode=creative,nbt=!{Inventory:[{id:"minecraft:carrot_on_a_stick",tag:{Tags:["material_emancipation_tool_1"]}}]}] minecraft:carrot_on_a_stick{Unbreakable:1,display:{Name:"{\"text\":\"Material Emancipation Grill - 1\"}",Lore:["Material Emancipation Grill - 1"]},HideFlags:63,Tags:["material_emancipation_tool_1"],Damage:17} 1
give @a[tag=material_emancipation_grill_2_setup,gamemode=creative,nbt=!{Inventory:[{id:"minecraft:carrot_on_a_stick",tag:{Tags:["material_emancipation_tool_2"]}}]}] minecraft:carrot_on_a_stick{Unbreakable:1,display:{Name:"{\"text\":\"Aperture Science Universal Editor\"}",Lore:["Material Emancipation Grill - 2"]},HideFlags:63,Tags:["material_emancipation_tool_2"],Damage:17} 1
give @a[tag=material_emancipation_grill_2_setup,gamemode=creative,nbt=!{Inventory:[{id:"minecraft:carrot_on_a_stick",tag:{Tags:["exit_tool"]}}]}] minecraft:carrot_on_a_stick{Unbreakable:1,display:{Name:"{\"text\":\"Aperture Science Universal Editor - Exit\",\"color\":\"black\"}",Lore:["Exit Editor"]},HideFlags:63,Tags:["exit_tool","menu1"],Damage:16} 1
give @a[tag=material_emancipation_grill_1_setup,gamemode=creative,nbt=!{Inventory:[{id:"minecraft:carrot_on_a_stick",tag:{Tags:["exit_tool"]}}]}] minecraft:carrot_on_a_stick{Unbreakable:1,display:{Name:"{\"text\":\"Aperture Science Universal Editor - Exit\",\"color\":\"black\"}",Lore:["Exit Editor"]},HideFlags:63,Tags:["exit_tool","menu1"],Damage:16} 1
sa 



execute as @a[tag=material_emancipation_grill_1_setup,scores={shiftedit=0}] at @s unless entity @e[tag=material_emancipation_grill_base_setup] run summon armor_stand ^ ^ ^ {Invisible:1b,Invulnerable:1b,PersistenceRequired:1b,NoBasePlate:1b,NoGravity:1b,ArmorItems:[{},{},{},{id:"diamond_hoe",Count:1b,tag:{Damage:1521,Unbreakable:1}}],DisabledSlots:2037535,Tags:["material_emancipation_grill_base_setup","useless","meg1","hoverignore"],Glowing:1}
execute as @a[tag=material_emancipation_grill_2_setup,scores={shiftedit=0}] at @s unless entity @e[tag=material_emancipation_grill_base_setup] run summon armor_stand ^ ^ ^ {Invisible:1b,Invulnerable:1b,PersistenceRequired:1b,NoBasePlate:1b,NoGravity:1b,ArmorItems:[{},{},{},{id:"diamond_hoe",Count:1b,tag:{Damage:1519,Unbreakable:1}}],DisabledSlots:2037535,Tags:["material_emancipation_grill_base_setup","useless","meg2","hoverignore"],Glowing:1}
...
execute as @e[tag=material_emancipation_grill_base_setup] at @s at @p[tag=material_emancipation_grill_2_setup,tag=S] run tp @s ^1 ^ ^3  0
...
execute as @e[tag=material_emancipation_grill_base_set] run data merge entity @s {Glowing:0}
